...
//Classifier to check if the username has symbols, as symbols along with other machine made indicators, usually implies bot made user accounts most of the time
