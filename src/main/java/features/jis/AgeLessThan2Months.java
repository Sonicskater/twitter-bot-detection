...
//This class is for checking if the user account is less than 2 months old, the date May 28, 2021 is currently used because of dataset used is of that date.
